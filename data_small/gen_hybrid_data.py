...
mode = 'train'
label = "E:\\pythonwork\\deep_learning\\big_homework\\SAN-main\\dataset-from-wan\\%s_caption.txt"%mode
out = "E:\\pythonwork\\deep_learning\\big_homework\\SAN-main\\dataset-from-wan\\%s_hyb"%mode
